...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("sidebar_collapsed", sa.Boolean(), nullable=False, server_default=sa.text("false")),
        sa.Column("copilot_enabled", sa.Boolean(), nullable=False, server_default=sa.text("true")),
