...
5. Login, upload ERA, process, and review worklist:
    ...
    - Make targets (same command flow): `make era-login BASE_URL=http://127.0.0.1:8000 EMAIL=admin@example.com PASSWORD=ChangeMeNow!`, `make era-ingest DIR=/absolute/path/to/era-pdfs BASE_URL=http://127.0.0.1:8000 EMAIL=admin@example.com PASSWORD=ChangeMeNow!`, `make era-watch DIR=/absolute/path/to/watch POLL_SECONDS=2 BASE_URL=http://127.0.0.1:8000 EMAIL=admin@example.com PASSWORD=ChangeMeNow!`
6. Tests:
    - make test
    - make test-pg
