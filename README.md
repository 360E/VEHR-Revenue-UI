...
- Run repeatable load harness:
  - `python scripts/load_test.py --dir /absolute/path/to/tests/fixtures/era --base-url http://127.0.0.1:8000 --email admin@example.com --password ChangeMeNow! --workers 5 --iterations 1 --memory-ceiling-mb 1024`
...
- Harness output includes:
  ...
  - max RSS memory observed and DB invariant pass/fail gate
